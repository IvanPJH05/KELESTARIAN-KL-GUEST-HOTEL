...
function moneyCard(label,value){return `<article class="metric"><span>${label}</span><strong>RM ${value.toLocaleString(undefined,{minimumFractionDigits:2,maximumFractionDigits:2})}</strong></article>`}
